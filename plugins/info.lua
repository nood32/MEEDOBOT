...
local function callback_reply(extra, success, result)
	--icon & rank & meedo ------------------------------------------------------------------------------------------------
	userrank = "Member"
	if tonumber(result.from.peer_id) == 324329857 then
		userrank = "Master king ⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐"
...
local function callback_res(extra, success, result)
	...
	--icon & rank & by meedo ------------------------------------------------------------------------------------------------
	if tonumber(result.id) == 324329857 then
		userrank = "Master king ⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐"
		send_document(org_chat_id,"umbrella/stickers/master.webp", ok_cb, false)
	elseif is_sudo(result) then
		userrank = "Sudo ⭐⭐⭐⭐⭐"
	...
	elseif #matches == 2 then
		...
		if not msg.reply_id then
			...
			if tonumber(msg.from.id) == 324329857 then
				userrank = "الملك ⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️"
...
return {
	...
	usagehtm = 'ملف يعطيك معلومات كاملة عنك من المطور @meedo1133 ',
	usage = {
		user = {
			"info: اطلاعات شما",
