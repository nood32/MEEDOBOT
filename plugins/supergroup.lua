    ...
    for k,v in pairs(result) do
        ...
        if vusername == member or vpeer_id == memberid then
            ...
            if group_owner then
				...
				if result.username then
                	text = member_username.." [@"..v.username.."] \nتـمـ☑️ رفـعـك مــد😸يــر للــمــجــمــوعــة👥 شد لك جراره تجبر كلبي   \n 👨‍✈️ المطور : @meedo1133"
				else
					text =" [@"..v.username.."] \nتـمـ☑️ رفـعـك مــد😸يــر للــمــجــمــوعــة👥 شد لك جراره حبيب كلبي  \n 👨‍✈️ المطور : @meedo1133"
				end
			end
...
local function set_supergroup_photo(msg, success, result)
  ...
  if success then
    ...
    save_data(_config.moderation.data, data)
    send_large_msg(receiver, 'اهلا وسهلا بك 😻❤️\n '..msg.from.first_name..'\nتـمـ☑️ حـفـظ الـصـ📷ـوره لــلــمــجــمــوعــة 👥  \n👨‍✈️ المطور : @meedo1133 ', ok_cb, false)
  else
