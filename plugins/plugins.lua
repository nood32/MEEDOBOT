...
local function enable_plugin( plugin_name )
  ...
  if plugin_exists(plugin_name) then
    ...
    return ''..plugin_name..' لا يوجد ملف بهذا الاسم في الملفات راجع المطور  \n👨‍✈️ المطور : @meedo1133 '
  end
end
...
local function disable_plugin( name, chat )
  ...
  if not plugin_exists(name) then
    return ''..name..' لا يوجد ملف بهذا الاسم في الملفات راجع المطور  \n👨‍✈️ المطور : @meedo1133'
  end
...
local function run(msg, matches)
  ...
  if matches[1] == 'تفعيل' and matches[3] == 'chat' then
  ...
  -- Enable a plugin
  if matches[1] == 'تفعيل' and is_sudo(msg) then --after changed to moderator mode, set only sudo
  ...
  if matches[1] == 'تعطيل' and matches[3] == 'chat' then
    local plugin = matches[2]
    local receiver = get_receiver(msg)
  ...
  -- Disable a plugin
  if matches[1] == 'تعطيل' and is_sudo(msg) then --after changed to moderator mode, set only sudo
