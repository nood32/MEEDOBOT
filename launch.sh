...
if [ "$1" = "install" ]; then
 ...
 ## chmod 777 config_fix.sh
  ...
  echo -e "       CH > @meedoyemen         " 
  echo -e "       CH > @meedoyemen           " 
  echo -e "       CH > @meedoyemen          \033[0;00m"
  echo -e "\e[36m"                                      
  echo -e "CH > @meedoyemen" 
   cat << EOF
✄╔═╗╔═╗─────╔═══╗──╔══╗──╔════╗dev:@meedo1133
...
✄╚╝╚╝╚╩══╩══╩═══╩══╩═══╩══╝╚╝  inst:@meedoyemen
EOF
echo -e "\e[100m          CH > @meedoyemen        \e[00;37;40m"
echo -e "\e[01;34m        CH > @meedoyemen         \e[00;37;40m"
echo ""
  ...
  ./tg/bin/telegram-cli -k ./tg/tg-server.pub -s ./MEEDOBOT/MEEDOBOT.lua -l 1 -E $@
fi
